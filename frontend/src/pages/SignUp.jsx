...
const SignUp = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center pt-16 relative bg-slate-50">
            ...
            <motion.div
                ...
                className="bg-white/80 backdrop-blur-md shadow-2xl p-10 rounded-3xl w-full max-w-md relative z-10 mx-4 border border-white"
            >
                ...
                <form onSubmit={handleSignUp} className="space-y-5">
                    ...
                    <button
                        type="submit"
                        disabled={loading}
                        className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg transition-all focus:ring-4 focus:outline-none flex justify-center items-center"
                    >
